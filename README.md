...
#### Benign 
![alt text](https://github.com/GhnimiWael/Breast-Cancer-Detection/blob/main/image/Begign.png)
#### Malignant
![alt text](https://github.com/GhnimiWael/Breast-Cancer-Detection/blob/main/image/malignant.png)
# Image Processing
...
![atl text](https://github.com/GhnimiWael/Breast-Cancer-Detection/blob/main/image/processing.png)
...
>!git clone https://github.com/GhnimiWael/Breast-Cancer-Detection.git
...
# App Display
### 1. Web Page
![atl text](https://github.com/GhnimiWael/Breast-Cancer-Detection/blob/main/image/webpage.png)
### 2. Prediction
![atl text](https://github.com/GhnimiWael/Breast-Cancer-Detection/blob/main/image/prediction.png)
### 3. Prediction after cropping image (in the app itself)
![atl text](https://github.com/GhnimiWael/Breast-Cancer-Detection/blob/main/image/after%20cropping.png)
